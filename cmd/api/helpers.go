...
// envelope is a custom type which we will use as the top-level structure for all of our JSON responses.
// This will allow us to easily add additional metadata to our responses in the future if we need to, without having to change the underlying structure of the JSON.
...
func (app *application) writeJSON(w http.ResponseWriter, status int, data envelope, headers http.Header) error {
	...
	// Add a newline character to the end of the JSON response for improved readability in terminal output.
	js = append(js, '\n')
...
func (app *application) readJSON(w http.ResponseWriter, r *http.Request, dst any) error {
	...
	// Decode the request body into the target destination. If there is an error, we
	err := dec.Decode(dst)
	if err != nil {
